...
class Strategist(sc2.BotAI) :
    ...
    def on_start(self) :
        ...
        for th in self.townhalls.ready:
            vgs = self.state.vespene_geyser.closer_than(20, th)
        ...
        self.buildOrder = [
            ...
            (44,Task(0, UnitTypeId.BARRACKS, self.main_base_ramp.barracks_in_middle, None)),
            (92,Task(2, UnitTypeId.COMMANDCENTER, None, AbilityId.UPGRADETOORBITAL_ORBITALCOMMAND)),
